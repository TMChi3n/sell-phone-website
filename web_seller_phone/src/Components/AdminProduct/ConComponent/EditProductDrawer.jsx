...
const EditProductDrawer = ({ form, isDrawerOpen, onClose, updateMutation }) => (
  <Drawer
    title="Edit Product"
  ...
  onFinish={(values) => {
    ...
    if (isNaN(productId)) {
      notification.error({ message: 'Invalid product ID', description: 'Please enter a valid product ID.' });
      return;
    }
